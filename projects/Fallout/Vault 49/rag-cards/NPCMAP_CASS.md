<rag_card id="npc.cass.epistemic" type="npc_epistemic_profile" entity="Cass Holloway — Knowledge Map" spoiler_level="mixed" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Cass Holloway — Knowledge Map</canonical_name>
<project>Fallout / Vault 49</project>
<source_file>modular-full/NPC_Maps/NPC_MAP_CASS.md</source_file>
<aliases>Cass Holloway — Knowledge Map, Cass, NPC MAP CASS</aliases>
<retrieval_keywords>Fallout / Vault 49, NPC_Maps, Cass Holloway — Knowledge Map, Cass, NPC MAP CASS, NPC_MAP_CASS — Cass Holloway — Knowledge Map, Cass Holloway, Knows, Does not know, Has a stance on, Would cite under pressure, Epistemic posture, How she responds to theories she cannot rule out</retrieval_keywords>
<related_cards>project.fallout_vault_49, category.npcmap, cast.cass.prose</related_cards>
</card_meta>
...
<epistemic_content>
# NPC_MAP_CASS — Cass Holloway — Knowledge Map
...
Cross-references: monolithic source `KNOWLEDGE_7_NPC_Maps.md`; character voice/traits in `modular-full/Cast/CAST_CASS.md`; format reference in `NPC_MAP_DISCIPLINE.md`; hidden material in `modular-full/Hidden/`.
