<rag_card id="npc.discipline.epistemic" type="npc_epistemic_profile" entity="Format and use" spoiler_level="mixed" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Format and use</canonical_name>
<project>Fallout / Vault 49</project>
<source_file>modular-full/NPC_Maps/NPC_MAP_DISCIPLINE.md</source_file>
<aliases>Format and use, Discipline, NPC MAP DISCIPLINE</aliases>
<retrieval_keywords>Fallout / Vault 49, NPC_Maps, Format and use, Discipline, NPC MAP DISCIPLINE, NPC_MAP_DISCIPLINE — Format and use, Format, Notes on use</retrieval_keywords>
<related_cards>project.fallout_vault_49, category.npcmap, cast.discipline.prose</related_cards>
</card_meta>
