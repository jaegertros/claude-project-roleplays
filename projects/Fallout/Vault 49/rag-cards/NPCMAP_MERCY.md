<rag_card id="npc.mercy.epistemic" type="npc_epistemic_profile" entity="Mercy Quint — Knowledge Map" spoiler_level="mixed" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Mercy Quint — Knowledge Map</canonical_name>
<project>Fallout / Vault 49</project>
<source_file>modular-full/NPC_Maps/NPC_MAP_MERCY.md</source_file>
<aliases>Mercy Quint — Knowledge Map, Mercy, NPC MAP MERCY</aliases>
<retrieval_keywords>Fallout / Vault 49, NPC_Maps, Mercy Quint — Knowledge Map, Mercy, NPC MAP MERCY, NPC_MAP_MERCY — Mercy Quint — Knowledge Map, Mercy Quint, Knows, Does not know, Has a stance on, Would cite under pressure, Epistemic posture, How she responds to theories she cannot rule out</retrieval_keywords>
<related_cards>project.fallout_vault_49, category.npcmap, cast.mercy.prose</related_cards>
</card_meta>
...
<epistemic_content>
# NPC_MAP_MERCY — Mercy Quint — Knowledge Map
...
Cross-references: monolithic source `KNOWLEDGE_7_NPC_Maps.md`; character voice/traits in `modular-full/Cast/CAST_MERCY.md`; format reference in `NPC_MAP_DISCIPLINE.md`; hidden material in `modular-full/Hidden/`.
