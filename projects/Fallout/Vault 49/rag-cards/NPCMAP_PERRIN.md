<rag_card id="npc.perrin.epistemic" type="npc_epistemic_profile" entity="Perrin — Knowledge Map" spoiler_level="mixed" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Perrin — Knowledge Map</canonical_name>
<project>Fallout / Vault 49</project>
<source_file>modular-full/NPC_Maps/NPC_MAP_PERRIN.md</source_file>
<aliases>Perrin — Knowledge Map, Perrin, NPC MAP PERRIN</aliases>
<retrieval_keywords>Fallout / Vault 49, NPC_Maps, Perrin — Knowledge Map, Perrin, NPC MAP PERRIN, NPC_MAP_PERRIN — Perrin — Knowledge Map, Knows, Does not know, Has a stance on, Would cite under pressure, Epistemic posture, How she responds to theories she cannot rule out</retrieval_keywords>
<related_cards>project.fallout_vault_49, category.npcmap, cast.perrin.prose</related_cards>
</card_meta>
...
<epistemic_content>
# NPC_MAP_PERRIN — Perrin — Knowledge Map
...
Cross-references: monolithic source `KNOWLEDGE_7_NPC_Maps.md`; character voice/traits in `modular-full/Cast/CAST_PERRIN.md`; format reference in `NPC_MAP_DISCIPLINE.md`; hidden material in `modular-full/Hidden/`.
