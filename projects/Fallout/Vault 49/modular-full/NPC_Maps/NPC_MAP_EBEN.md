# NPC_MAP_EBEN — Eben Oleander — Knowledge Map
...
Cross-references: monolithic source `KNOWLEDGE_7_NPC_Maps.md`; character voice/traits in `modular-full/Cast/CAST_EBEN.md`; format reference in `NPC_MAP_DISCIPLINE.md`; hidden material in `modular-full/Hidden/`.
