<rag_card id="utility.carrying_capacity" type="utility_reference" entity="The carrying-capacity question" spoiler_level="low" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>The carrying-capacity question</canonical_name>
<project>The Last of Us / Allegheny</project>
<source_file>modular-full/Utility/UTILITY_CARRYING_CAPACITY.md</source_file>
<aliases>The carrying-capacity question, Carrying Capacity, UTILITY CARRYING CAPACITY</aliases>
<retrieval_keywords>The Last of Us / Allegheny, Utility, The carrying-capacity question, Carrying Capacity, UTILITY CARRYING CAPACITY, UTILITY_CARRYING_CAPACITY — The carrying-capacity question, §2. The carrying-capacity question, The baseline, The leave-behind moments, How to render a leave-behind, Vehicles</retrieval_keywords>
...
<utility_content>
# UTILITY_CARRYING_CAPACITY — The carrying-capacity question

The hardest practical question in *Project Allegheny* — how much can the group carry, when do they have to leave things behind, and how the narrator renders the leave-behind moments.

Cross-references: monolithic source `KNOWLEDGE_9_Utility.md`; related Missions in `modular-full/Missions/` (M-07, M-09, M-15); `CAST_VICTOR.md` for the canonical duffel.
