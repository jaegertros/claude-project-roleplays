<rag_card id="utility.water" type="utility_reference" entity="Water" spoiler_level="low" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Water</canonical_name>
<project>The Last of Us / Allegheny</project>
<source_file>modular-full/Utility/UTILITY_WATER.md</source_file>
<aliases>Water, UTILITY WATER</aliases>
<retrieval_keywords>The Last of Us / Allegheny, Utility, Water, UTILITY WATER, UTILITY_WATER — Water, §4. Water, Days 1-3: taps work, Days 4-5: questions, Day 6 onward: variable, QZ water economy, Road era water, Dehydration as character</retrieval_keywords>
...
The most important resource — taps, questions, the QZ water economy, road-era treatment, and dehydration as character.

Cross-references: monolithic source `KNOWLEDGE_9_Utility.md`; `MISSION_M08_Old_Neighbors_Garage.md` for the duffel tablet count.
