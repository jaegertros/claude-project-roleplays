<rag_card id="utility.medical" type="utility_reference" entity="Medical" spoiler_level="low" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Medical</canonical_name>
<project>The Last of Us / Allegheny</project>
<source_file>modular-full/Utility/UTILITY_MEDICAL.md</source_file>
<aliases>Medical, UTILITY MEDICAL</aliases>
<retrieval_keywords>The Last of Us / Allegheny, Utility, Medical, UTILITY MEDICAL, UTILITY_MEDICAL — Medical, §5. Medical, What's in a small medical kit, Antibiotics, Painkillers, Anti-anxiety and anti-depressants, Wound treatment in the field, Long-term wound and chronic conditions</retrieval_keywords>
...
<utility_content>
# UTILITY_MEDICAL — Medical

Beyond bites — the medical economy of *Project Allegheny*: kits, antibiotics, painkillers, withdrawal, wound treatment, and chronic conditions among named characters.

Cross-references: monolithic source `KNOWLEDGE_9_Utility.md`; `KNOWLEDGE_4_Infection.md` for bite-medical specifics; `MISSION_M08_Old_Neighbors_Garage.md` for the duffel contents; `FACTION_FIREFLIES.md` for Erin's stash.
