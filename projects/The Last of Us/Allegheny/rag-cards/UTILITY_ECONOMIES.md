<rag_card id="utility.economies" type="utility_reference" entity="The economies" spoiler_level="low" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>The economies</canonical_name>
<project>The Last of Us / Allegheny</project>
<source_file>modular-full/Utility/UTILITY_ECONOMIES.md</source_file>
<aliases>The economies, Economies, UTILITY ECONOMIES</aliases>
<retrieval_keywords>The Last of Us / Allegheny, Utility, The economies, Economies, UTILITY ECONOMIES, UTILITY_ECONOMIES — The economies, §8. The economies, Pre-outbreak (Days 1-3), Outbreak week (Days 3-7), QZ era — FEDRA scrip, QZ era — the barter market, Road era</retrieval_keywords>
...
<utility_content>
# UTILITY_ECONOMIES — The economies

How value is denominated across acts — US dollars, the brief outbreak-week barter, FEDRA scrip, the QZ barter market, and the road economy.

Cross-references: monolithic source `KNOWLEDGE_9_Utility.md`; `FACTION_FEDRA.md` and `MISSION_M11_Inside_The_Wire.md` for the QZ market; `MISSION_M15_The_Road.md` for the road era.
