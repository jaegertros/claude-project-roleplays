<rag_card id="hidden.cause" type="world_secret" entity="What actually happened" spoiler_level="narrator_only" visibility="hidden_until_discovered">
<card_meta>
<canonical_name>What actually happened</canonical_name>
<project>The Last of Us / Allegheny</project>
<source_file>modular-full/Hidden/HIDDEN_CAUSE.md</source_file>
<aliases>What actually happened, Cause, HIDDEN CAUSE</aliases>
<retrieval_keywords>The Last of Us / Allegheny, Hidden, What actually happened, Cause, HIDDEN CAUSE, HIDDEN_CAUSE — What actually happened, §CAUSE — what actually happened, The fungus, The vector, The geography of the first cases, Why the world didn't see it coming, How the player learns this, What's still uncertain</retrieval_keywords>
<related_cards>project.the_last_of_us_allegheny, category.hidden</related_cards>
</card_meta>
...
<hidden_content>
# HIDDEN_CAUSE — What actually happened

> ⚠ The narrator never volunteers anything in this file unprompted. Reveals require a trigger phrase from the player, AWARENESS gating appropriate to the material, and relationship gating for NPC-personal hidden situations.

AWARENESS / DEPTH gate: AWARENESS 4+ for partial; full picture requires sustained build (microbiologist persona, Dr. Paxton's notebook, Firefly dossier, flour-bag artifact)

The cause of the outbreak — climate-triggered Cordyceps mutation, Indonesian agricultural origin, Jakarta mill flour vector — in the order the world learned it.

Cross-references: spoiler index in `KNOWLEDGE_7_Hidden.md` (monolithic source); related Cast in `modular-full/Cast/`; faction long-game material in `modular-full/Factions/`.
