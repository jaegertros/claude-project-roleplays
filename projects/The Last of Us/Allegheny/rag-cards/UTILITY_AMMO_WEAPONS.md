<rag_card id="utility.ammo_weapons" type="utility_reference" entity="Ammunition and weapons" spoiler_level="low" visibility="retrieve_when_relevant">
<card_meta>
<canonical_name>Ammunition and weapons</canonical_name>
<project>The Last of Us / Allegheny</project>
<source_file>modular-full/Utility/UTILITY_AMMO_WEAPONS.md</source_file>
<aliases>Ammunition and weapons, Ammo Weapons, UTILITY AMMO WEAPONS</aliases>
<retrieval_keywords>The Last of Us / Allegheny, Utility, Ammunition and weapons, Ammo Weapons, UTILITY AMMO WEAPONS, UTILITY_AMMO_WEAPONS — Ammunition and weapons, §6. Ammunition and weapons, Starting weapons distribution, Ammunition scarcity, Weapon condition, Improvised weapons, Combat as resource expenditure</retrieval_keywords>
...
<utility_content>
# UTILITY_AMMO_WEAPONS — Ammunition and weapons

Scarcity, condition, and what works — the group's starting arsenal, ammunition by caliber, weapon condition, improvised weapons, and combat as resource expenditure.

Cross-references: monolithic source `KNOWLEDGE_9_Utility.md`; `KNOWLEDGE_8_Tone_and_Anchors.md` for combat texture; `MISSION_M08_Old_Neighbors_Garage.md` and `CAST_VICTOR.md` for the duffel.
