...
The single most important resource after water — abundance, the rush, rationing, the QZ ration system, road-era scavenge and foraging, and hunger as character.

Cross-references: monolithic source `KNOWLEDGE_9_Utility.md`; `KNOWLEDGE_8_Tone_and_Anchors.md` for hunger texture; `KNOWLEDGE_7_Hidden.md` for the Sumber Pertama bag.
